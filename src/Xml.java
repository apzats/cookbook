...
public class Xml {
    ...
    public String deserializeXml(String resultXml) {
        XmlMapper xmlMapper = new XmlMapper();
        String deserializedXmlString = "";
        ...
        deserializedXmlString = "Рецепт: " + newBook.getTextRecipes();
        }catch (JsonProcessingException e) {
            System.out.println(e.getMessage());
        }
        return deserializedXmlString;
